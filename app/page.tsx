      ...
      <section ref={sectionRef} className="py-20 md:py-32 px-6 lg:px-12 bg-[#F7F3E8]">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            {/* UPDATED: Side-by-side flexbox stats for ISO/NSIC */}
            <div className="space-y-6 md:space-y-8 mb-16 w-full">
              
              <motion.div variants={fadeUp} className="flex flex-row items-center gap-6 md:gap-10 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                <span className="text-4xl md:text-5xl font-black text-[#F5C518] drop-shadow-md leading-[1.1] min-w-[150px] md:min-w-[200px]">
                  5
                </span>
                <span className="text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  Industries served
                </span>
              </motion.div>
              ...
              <motion.div variants={fadeUp} className="flex flex-row items-center gap-6 md:gap-10 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                ...
                <span className="text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  CERTIFIED QUALITY<br/>MANAGEMENT SYSTEM
                </span>
              </motion.div>

              <motion.div variants={fadeUp} className="flex flex-row items-center gap-6 md:gap-10 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                <span className="text-4xl md:text-5xl font-black text-[#F5C518] drop-shadow-md leading-[1.1] min-w-[150px] md:min-w-[200px]">
                  NSIC<br/>CRISIL SE<br/>2B
                </span>
                <span className="text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  INDEPENDENTLY RATED
                </span>
