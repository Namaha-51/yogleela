...
// ---------------------------------------------------
// SUPER HEAVY AWWWARDS ANIMATION VARIANTS (TS Safe)
// ---------------------------------------------------
const transitionLux = { duration: 1.4, ease: "easeInOut" as const };
...
const fadeUpSlow = {
  ...
  visible: { opacity: 1, y: 0, transition: { duration: 1.8, ease: "easeInOut" as const } }
};
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex items-center gap-6">
              <Link href="/products" className="group flex items-center justify-center w-16 h-16 bg-emerald-900 text-white rounded-full hover:bg-emerald-800 hover:scale-105 transition-all duration-500 shadow-xl shadow-emerald-900/20">
                <svg className="w-5 h-5 -rotate-45 group-hover:rotate-0 transition-transform duration-500 ease-in-out" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
              </Link>
        ...
        >
          <div className="lg:w-5/12 z-10">
            ...
            <motion.div variants={fadeUp}>
              <Link href="/contact" className="inline-flex items-center gap-3 text-sm font-semibold text-slate-900 hover:text-emerald-700 transition-colors group">
                Partner with us 
                <span className="w-8 h-8 rounded-full border border-slate-300 flex items-center justify-center group-hover:border-emerald-600 group-hover:bg-emerald-50 transition-all duration-500 ease-in-out">
          ...
          <div className="lg:w-7/12 relative w-full h-[600px] perspective-[1000px]">
            ...
            <motion.div style={{ y: card1Y }} className="absolute top-0 right-0 w-3/4 h-[400px] rounded-3xl overflow-hidden shadow-2xl shadow-slate-200/50 z-20 group">
              <motion.div whileHover={{ scale: 1.1 }} transition={{ duration: 1.5, ease: "easeInOut" }} className="absolute inset-0 w-full h-full">
          ...
          <div className="flex flex-col border-t border-slate-200">
            {[
              ...
              <motion.div variants={fadeUpSlow} key={i}>
                <Link href={ind.link} className="group flex flex-col lg:flex-row items-start lg:items-center justify-between py-10 border-b border-slate-200 hover:px-6 hover:bg-slate-50 transition-all duration-700 ease-in-out">
                  <div className="w-full lg:w-1/3 mb-6 lg:mb-0 transform group-hover:translate-x-4 transition-transform duration-700 ease-in-out">
                    <h3 className="text-3xl font-light text-slate-900 group-hover:text-emerald-800 transition-colors">{ind.title}</h3>
                  </div>
                  
                  <div className="w-full lg:w-1/3 mb-6 lg:mb-0 px-0 lg:px-8 transform group-hover:translate-x-2 transition-transform duration-700 delay-75 ease-in-out">
                  ...
                  <div className="w-full lg:w-1/3 flex items-center justify-end gap-8">
                    <div className="w-32 h-16 rounded-full bg-slate-200 overflow-hidden relative opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 transition-all duration-700 ease-in-out hidden md:block">
                       <div className="absolute inset-0 bg-[url('/images/hero-bg.png')] bg-cover bg-center"></div>
                    </div>
