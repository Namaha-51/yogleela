    ...
    <main className="min-h-screen bg-white text-[#1F2A24] selection:bg-[#F5C518] selection:text-[#0B2B1C] overflow-x-hidden pt-0">
     ...
     {/* FLOATING WHATSAPP BUTTON */}
      <motion.a 
        ...
        href="https://wa.me/919920306668?text=Hi%2C%20I%20am%20interested%20in%20working%20with%20Yogleela%20Sulphur%20and%20Agchem%20Industries%20Private%20Limited.%20Please%20share%20more%20information%20about%20your%20products%20and%20how%20we%20can%20work%20together.%20Thank%20you." 
        target="_blank" 
      ...
      <section className="py-20 md:py-32 px-6 lg:px-12 bg-[#0B2B1C] text-white border-t-4 border-[#F5C518]">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-7xl mx-auto">
          ...
          {/* Flex Wrap for perfect centering of the bottom two tiles */}
      ...
      {/* 3. WHY BUYERS STAY (Heavy Parallax & Inline Stats) */}
      <section ref={sectionRef} className="py-20 md:py-32 px-6 lg:px-12 bg-[#F7F3E8]">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
          ...
          {/* UPDATED: Strict Flex boundaries to isolate text and prevent overlap */}
            <div className="space-y-6 md:space-y-8 mb-16 w-full">
              
              <motion.div variants={fadeUp} className="flex flex-row items-center gap-4 md:gap-6 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                <span className="w-[160px] sm:w-[200px] md:w-[250px] lg:w-[320px] flex-shrink-0 text-3xl md:text-4xl lg:text-5xl font-black text-[#F5C518] drop-shadow-md leading-[1.1]">
                  5
                </span>
                <span className="flex-1 text-xs sm:text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  Industries served
                </span>
              </motion.div>

              <motion.div variants={fadeUp} className="flex flex-row items-center gap-4 md:gap-6 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                <span className="w-[160px] sm:w-[200px] md:w-[250px] lg:w-[320px] flex-shrink-0 text-[1.2rem] sm:text-2xl md:text-3xl lg:text-4xl font-black text-[#F5C518] drop-shadow-md leading-[1.1] whitespace-nowrap">
                  ISO 9001:2015
                </span>
                <span className="flex-1 text-xs sm:text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  CERTIFIED QUALITY<br className="hidden lg:block"/>MANAGEMENT SYSTEM
                </span>
              </motion.div>

              <motion.div variants={fadeUp} className="flex flex-row items-center gap-4 md:gap-6 border-b-2 border-[#0B2B1C]/10 pb-6 w-full">
                <span className="w-[160px] sm:w-[200px] md:w-[250px] lg:w-[320px] flex-shrink-0 text-[0.95rem] sm:text-[1.1rem] md:text-2xl lg:text-[2rem] font-black text-[#F5C518] drop-shadow-md leading-[1.1] whitespace-nowrap">
                  NSIC CRISIL SE 2B
                </span>
                <span className="flex-1 text-xs sm:text-sm md:text-base font-bold text-[#1F2A24] uppercase tracking-wider leading-snug">
                  INDEPENDENTLY RATED
      ...
      <section className="py-20 md:py-32 px-6 lg:px-12 bg-[#0B2B1C] relative overflow-hidden">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-5xl mx-auto text-center flex flex-col items-center relative z-10">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row justify-center gap-6 w-full sm:w-auto">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <a 
                href="https://wa.me/919920306668?text=Hi%2C%0A%0AI%20am%20interested%20in%20working%20with%20Yogleela%20Sulphur%20and%20Agchem%20Industries%20Private%20Limited.%0A%0APlease%20share%20more%20information%20about%20your" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="block w-full sm:w-auto px-10 py-5 bg-[#25D366] text-white text-xl font-bold rounded-lg shadow-2xl"
              >
                WhatsApp us
              </a>
            </motion.div>
