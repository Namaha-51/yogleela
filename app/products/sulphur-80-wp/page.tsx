...
export default function Sulphur80WPPage() {
  return (
    <main className="min-h-screen bg-white text-[#1F2A24] selection:bg-[#F5C518] selection:text-[#0B2B1C] pt-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          <div className="md:w-1/2 text-white">
            ...
            <div className="flex items-center gap-2 text-sm font-bold text-white/70 uppercase tracking-widest">
              ...
              <span>›</span>
              <span className="text-white">Sulphur 80% W.P.</span>
            </div>
          </div>
      ...
      <section className="py-20 px-6 lg:px-12 max-w-5xl mx-auto">
        <div className="mb-16">
          <p className="text-xl font-medium text-[#1F2A24] mb-6 leading-relaxed">
            Sulphur 80%W.P. is an contact fungicide sulphur containing 80% Sulphur as active ingredient and balance adjuvants 20% w/w.
          </p>
        </div>
        ...
        <div className="mb-16 overflow-x-auto">
          ...
          <table className="w-full border-collapse bg-[#F7F3E8] rounded-xl overflow-hidden shadow-md text-left mt-4">
            ...
            <tbody className="divide-y divide-[#0B2B1C]/10">
              {[
                ["Apples", "Powdery Mildew", "2 - 4", "2.5 - 5.0", "750-1000"],
                ["Grapes", "Powdery Mildew", "2 - 4", "2.5 - 5.0", "750-1000"],
                ["Groundnut", "Tikka Leaf Spot", "1.50-2.00", "1.875-2.50", "750-1000"],
                ["Cowpea, Moong, Urid", "Powdery Mildew", "2.5", "3.13", "750-1000"],
                ["Pea", "Rust / Powdery Mildew", "2.5", "3.13", "750-1000"],
                ["Sorghum", "Grain smut", "2.4-3.2 gm/kg seed", "3-4 gms/kg seed", "1Ltr/10 kgs. seed"],
                ["Chillies & okra", "Powdery Mildew", "2.5", "3.13", "750 - 1000"],
                ["Mango", "Powdery Mildew", "2.5", "3.13", "750 - 1000"],
                ["Citrus", "Powdery Mildew", "2.5", "3.13", "750 - 1000"],
              ].map((row, i) => (
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#F7F3E8] text-center border-t border-[#0B2B1C]/10">
        <h3 className="text-3xl md:text-4xl font-black text-[#0B2B1C] mb-8">Interested in SULPHUR 80% W.P.?</h3>
