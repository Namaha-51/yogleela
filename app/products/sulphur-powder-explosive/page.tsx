...
export default function SulphurExplosivePage() {
  return (
    <main className="min-h-screen bg-white text-[#1F2A24] selection:bg-[#F5C518] selection:text-[#0B2B1C] pt-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          <div className="md:w-1/2 text-white">
            ...
            <div className="flex items-center gap-2 text-sm font-bold text-white/70 uppercase tracking-widest">
              ...
              <span>›</span>
              <span className="text-white">Explosive Grade</span>
            </div>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="md:w-1/2 flex justify-center md:justify-end">
            <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg h-72 md:h-[400px] flex items-center justify-center">
              <img 
                src="/images/sulphurexplosive.png" 
                alt="Explosive Grade Sulphur" 
      ...
      <section className="py-20 px-6 lg:px-12 max-w-5xl mx-auto">
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h4 className="text-2xl font-black text-[#0B2B1C] mb-4 border-b-2 border-[#F5C518] inline-block pb-1">For Safety Matches</h4>
              <p className="text-lg font-medium leading-relaxed">
                In the safety matches industry, sulphur is mixed with phosphorous to prepare Phosphorous tri-sulphide (P2S3). This phosphorous tri-sulphide is used to prepare the match heads for ignition when stroked to the surface of the match box[cite: 8].
              </p>
            </div>
            <div>
              <h4 className="text-2xl font-black text-[#0B2B1C] mb-4 border-b-2 border-[#F5C518] inline-block pb-1">For Fire-Crackers</h4>
              <p className="text-lg font-medium leading-relaxed">
                Sulphur is an important constituent in the making of fireworks & firecrackers. The main ingredient used in firecrackers is Gunpowder which is made from sulphur[cite: 8].
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#F7F3E8] text-center border-t border-[#0B2B1C]/10">
        <h3 className="text-3xl md:text-4xl font-black text-[#0B2B1C] mb-8">Interested in Explosive Grade Sulphur?</h3>
