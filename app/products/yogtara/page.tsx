  ...
  return (
    <main className="min-h-screen bg-white text-[#1F2A24] selection:bg-[#F5C518] selection:text-[#0B2B1C] pt-20">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="md:w-1/2 flex justify-center md:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/20 shadow-2xl p-8">
              <img src="/images/cosmicstar.png" alt="YOGTARA / COSMIC STAR" className="w-full h-full object-contain drop-shadow-2xl" />
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-12 max-w-5xl mx-auto">
        <div className="mb-16">
          <p className="text-xl font-medium text-[#1F2A24] mb-6 leading-relaxed">
            It is a contact fungicide containing 85% w/w sulphur as active ingredient and balance adjuvants[cite: 13].
          </p>
        </div>
          ...
          <table className="w-full border-collapse bg-[#F7F3E8] rounded-xl overflow-hidden shadow-md text-left mt-4">
            ...
            <tbody className="divide-y divide-[#0B2B1C]/10">
              {[
                ...
                ["Pea", "Rust / Powdery Mildew", "12.75-17", "15-37.5"],
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg font-medium leading-relaxed">
                Equipment used in application:- Knapsack below cluster, manually operated rotary cluster, motorised knapsack sprayer cum cluster[cite: 13].
              </p>
            </div>
            <div>
              <h4 className="text-2xl font-black text-[#0B2B1C] mb-4 border-b-2 border-[#F5C518] inline-block pb-1">Symptoms & First Aid</h4>
              <p className="text-lg font-medium leading-relaxed">
                Nausea, vomiting, headache and irritation to the bronchii, eyes and lungs may occur. If swallowed, induce vomiting by tickling the back of throat. Do not induce vomiting if the patient is unconscious[cite: 13].
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-6 lg:px-12 bg-[#F7F3E8] text-center border-t border-[#0B2B1C]/10">
        <h3 className="text-3xl md:text-4xl font-black text-[#0B2B1C] mb-8">Interested in YOGTARA / COSMIC STAR?</h3>
